...
**Project guide:** the authoritative "how we build" doc is `../CLAUDE.md` (project root), and the full product spec is `../docs/prd/prd.md`. This folder configures the tooling; `CLAUDE.md` documents the conventions.
